...
const userSchema = new mongoose.Schema(
  {
    ...
    about: {
      ...
      portfolio: {
        type: String,
        validate: [validator.isURL, "Please, provide a valid portfolio URL"],
        default: "https://www.example.com/your_portfolio_link",
      },
      social: {
        facebook: {
          type: String,
          validate: [validator.isURL, "Please, provide a valid facebook URL"],
          default: "https://www.example.com/your_facebook_link",
        },
        twitter: {
          type: String,
          validate: [validator.isURL, "Please, provide a valid twitter URL"],
          default: "https://www.example.com/your_twitter_link",
        },
      },
    },
